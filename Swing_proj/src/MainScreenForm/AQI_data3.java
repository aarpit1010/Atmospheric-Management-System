...
public class AQI_data3 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTable1.setBorder(new javax.swing.border.SoftBevelBorder(javax.swing.border.BevelBorder.RAISED, new java.awt.Color(102, 102, 102), new java.awt.Color(204, 204, 204), null, null));
        ...
        jLabel12.setText("GUPTA JI CANTEEN LOG DATA REPORT");
        ...
        SimpleDateFormat dateFormat = new SimpleDateFormat(""
                        + "yyyy-MM-dd::HH:mm:ss");
        String canteen_datetime;
        
        private void sub_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sub_btnActionPerformed
                canteen.decision();
                DefaultTableModel tbmodel=(DefaultTableModel)jTable1.getModel();
                String data[]={canteen_datetime,Double.toString(canteen.no2),
                    Double.toString(canteen.pm10),Double.toString(canteen.o3),
                    Double.toString(canteen.pm25),Double.toString(canteen.aqi_idx)};
                tbmodel.addRow(data);
    ...
    private void detect_dataActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detect_dataActionPerformed
              canteen_datetime = dateFormat.format(new Date());
              canteen.randGen();
              canteen.dataValue();
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
         MessageFormat header = new MessageFormat("Guptaji Canteen Log Report");
