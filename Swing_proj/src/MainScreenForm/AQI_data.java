...
public class AQI_data extends javax.swing.JFrame {

	/**
	 * Creates new form AQI_data
	 */
	public AQI_data() {
		initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1 =  new JPanel() {  
            public void paintComponent(Graphics g) {  
                Image img = Toolkit.getDefaultToolkit().getImage(  
                    AQI_data.class.getResource("/images/img1.jpg"));  
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(67, 67, 67)
                .addComponent(reset_btn, javax.swing.GroupLayout.PREFERRED_SIZE, 146, javax.swing.GroupLayout.PREFERRED_SIZE)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(res_aqi_data, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(qlty_data, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(cool_sys_data, javax.swing.GroupLayout.PREFERRED_SIZE, 173, javax.swing.GroupLayout.PREFERRED_SIZE))))))
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.CENTER)
                    ...
                    .addComponent(cool_sys_data, javax.swing.GroupLayout.PREFERRED_SIZE, 76, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(temp_data, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {cancel_btn, reset_btn, sub_btn});

        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {jLabel9, qlty_data});

        jPanel1Layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {hum_data, jLabel2, jLabel3, jLabel4, jLabel5, jLabel6, jLabel7, no2_data, o3_data, pm10_data, pm25_data, temp_data});
        ...
        if (jTable1.getColumnModel().getColumnCount() > 0) {
            ...
            jTable1.getColumnModel().getColumn(4).setMinWidth(59);
            jTable1.getColumnModel().getColumn(4).setPreferredWidth(59);
            jTable1.getColumnModel().getColumn(4).setMaxWidth(59);
            jTable1.getColumnModel().getColumn(5).setMinWidth(59);
            jTable1.getColumnModel().getColumn(5).setPreferredWidth(59);
            jTable1.getColumnModel().getColumn(5).setMaxWidth(59);
        }
        ...
        jLabel12.setText("CC3 LOG DATA REPORT");
        ...
        private class cc3sensorData{
                DecimalFormat df = new DecimalFormat("0.00");
                public double rand_no2;
                public double rand_pm10;
                public double rand_o3;
                public double rand_pm25;
                public double rand_temp;
                public double rand_hum;
                public double no2, pm10, o3, pm25, temp, hum, aqi_idx, avg_aqi_sum, avg_aqi;
                ...
                public void resetData() {
                    ...
                    cc3sensorData cc3sens = new cc3sensorData();
        ...
        private void sub_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_sub_btnActionPerformed
                ...
                String data[]={cc3_datetime,Double.toString(cc3sens.no2),
                    Double.toString(cc3sens.pm10),Double.toString(cc3sens.o3),
                    Double.toString(cc3sens.pm25),Double.toString(cc3sens.aqi_idx)};
                tbmodel.addRow(data);
        ...
        private void detect_data_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_detect_data_btnActionPerformed
                cc3_datetime = dateFormat.format(new Date());
                cc3sens.randGen();
                cc3sens.dataValue();
    ...
    private void sub_btnKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_sub_btnKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER) {
                cc3sens.decision();
                DefaultTableModel tbmodel=(DefaultTableModel)jTable1.getModel();
                String data[]={cc3_datetime,Double.toString(cc3sens.no2),Double.toString(cc3sens.pm10),Double.toString(cc3sens.o3),Double.toString(cc3sens.pm25),Double.toString(cc3sens.aqi_idx)};
                tbmodel.addRow(data);
        }
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
       MessageFormat header = new MessageFormat("CC3 Log Report");
	...
	public static void main(String args[]) {
		...
		try {
			...
			java.util.logging.Logger.getLogger(AQI_data.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
